...
const styles = {
  page: { padding: 30, background: "#111", color: "white", minHeight: "100vh" },
  container: { maxWidth: 700, margin: "auto" },
  card: { display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 },
  item: { display: "flex", gap: 10, marginBottom: 10, alignItems: "center" },
};